...
class MetaRegisters:
    ...
    QUIET_MODE_LEVEL: Final[ModbusVariableDescription] = ModbusVariableDescription(
        start_address=490,
        name="parHpSilentMode",
        friendly_name="HP058",
        data_type=DataType.UINT8,
    )
    """Heat pump silent/quiet mode level (0 = off, 1 = level 1, 2 = level 2)."""

    QUIET_MODE_START: Final[ModbusVariableDescription] = ModbusVariableDescription(
        start_address=491,
        name="parHpSilentModeStart",
        friendly_name="HP094",
        data_type=DataType.UINT8,
    )
    """Start of the heat pump silent period, in 10-minute units from midnight."""

    QUIET_MODE_END: Final[ModbusVariableDescription] = ModbusVariableDescription(
        start_address=492,
        name="parHpSilentModeEnd",
        friendly_name="HP095",
        data_type=DataType.UINT8,
    )
    """End of the heat pump silent period, in 10-minute units from midnight."""
